...
import { getLeagueStandings, getLeagueEventsPast, getLeagueEventsNext, getLeagueDetails } from '@/lib/thesportsdb';
import { mapStandings, mapMatch, mapLeague } from '@/lib/api-adapter';
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const [standingsData, lastFixtures, nextFixtures, leagueInfo] = await Promise.all([
    ...
    const getMockScorers = (leagueId: string) => {
      ...
      const players: Record<string, any[]> = {
        ...
        '4335': [{ player: { name: 'R. Lewandowski', id: 2, photo: 'https://www.thesportsdb.com/images/media/player/thumb/6tq1r91660144962.jpg' }, statistics: [{ team: { name: 'Barcelona', logo: 'https://www.thesportsdb.com/images/media/team/badge/small/66048q1611394142.png' }, goals: { total: 20 } }] }],
        '4332': [{ player: { name: 'L. Martinez', id: 3, photo: 'https://www.thesportsdb.com/images/media/player/thumb/v9v9v31661101836.jpg' }, statistics: [{ team: { name: 'Inter', logo: 'https://www.thesportsdb.com/images/media/team/badge/small/1vj2441680190928.png' }, goals: { total: 22 } }] }],
    ...
    const getMockAssists = (leagueId: string) => {
       const players: Record<string, any[]> = {
        '4328': [{ player: { name: 'K. De Bruyne', id: 10, photo: 'https://www.thesportsdb.com/images/media/player/thumb/p7uuvr1661101908.jpg' }, statistics: [{ team: { name: 'Man City', logo: 'https://www.thesportsdb.com/images/media/team/badge/small/v2v9v31680191836.png' }, goals: { assists: 12 } }] }],
       };
       return players[leagueId] || [];
    };
