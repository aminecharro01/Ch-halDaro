            ...
            <div className="flex-1 text-center md:text-left space-y-6">
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-sm font-bold text-gray-400 uppercase tracking-[0.2em]">
                  ...
                  <span className="flex items-center gap-2 text-green-500"><TrendingUp className="w-4 h-4" /> Season {league?.season}</span>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-900/40 backdrop-blur-md border border-white/5 rounded-[2rem] p-8 shadow-xl">
                <p className="text-gray-400 leading-relaxed font-medium">
                  {league.description.length > 800 
                    ? league.description.substring(0, 800) + '...' 
                    : league.description}
                </p>
                {league.description.length > 800 && (
                  <button className="mt-6 text-blue-500 text-sm font-black uppercase tracking-widest hover:text-blue-400 transition-colors flex items-center gap-1">
